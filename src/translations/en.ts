export const en = {
  ...
  'home.email.subtitle': 'Get a daily report delivered to your inbox every evening with all tracking data and CSV exports',
  'home.email.sample.subject': 'Daily Summary for Baby Emma - Feb 13',
  'home.email.sample.sleep': 'Total sleep: 14h 30m (6 naps)',
  'home.email.sample.feeding': 'Feedings: 8 sessions (breast + bottle)',
  'home.email.sample.diaper': 'Diapers: 10 changes (6 wet, 4 dirty)',
